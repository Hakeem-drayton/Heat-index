def main():
    ...
    if num_Location <= 0:
        print("Error!")
        exit(-1)
    precision = int(input("Enter the precise decimal"))
    ...
    for x in range(num_Location):
        ...
        print(humiditys.append(humidity))
        (HIs.append(HI))
    ...
    average_humidity = humidity + humidity // num_Location
    print("The average humidity is:", average_humidity)
main()
